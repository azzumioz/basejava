...
public class ResumeTestData {
    ...
    public static Resume getResume(String uuid, String fullName) {
        ...
        r1.setSections(SectionType.ACHIEVEMENT, new ListSection(
        ...
        r1.setSections(SectionType.QUALIFICATIONS, new ListSection(
                "JEE AS: GlassFish (v2.1, v3), OC4J, JBoss, Tomcat, Jetty, WebLogic, WSO2",
                "Version control: Subversion, Git, Mercury, ClearCase, Perforce",
                "DB: PostgreSQL(наследование, pgplsql, PL/Python), Redis (Jedis), H2, Oracle,"));

        r1.setSections(SectionType.EXPERIENCE, new OrganizationSection(
        ...
        r1.setSections(SectionType.EDUCATION, new OrganizationSection(
